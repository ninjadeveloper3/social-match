            ...
            ListTile(
              ...
              subtitle: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  String packageName = _usageStats[index].packageName;
                  String formattedDuration =
                      formatDuration(_usageStats[index].usage);

                  if (socialMediaPackageNames.contains(packageName)) {
                    String socialMediaName = socialMediaNames[packageName]!;
